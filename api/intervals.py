...
@router.get('/datasets/{datasetId}/intervals/{intervalId}/primitiveTraceForwardOld')
def primitive_trace_forward_old(datasetId: str,
                            intervalId: str,
                            bins: int = 100,
                            begin: int = None,
                            end: int = None,
    ...
    return StreamingResponse(traceForwardOld(), media_type='application/json')
