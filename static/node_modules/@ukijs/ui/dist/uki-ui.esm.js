  ...
  classDefFunc: SuperClass => {
    class GLRootView extends RecolorableImageViewMixin(ThemeableMixin({
      ...
      constructor (options) {
        ...
        // abstract that requirement away with this._glLayout referring to
        ...
        this._glLayout = this._glSettings.content[0];
      ...
      createView (ViewClass, glContainer, glState) {
        return new ViewClass({ glContainer, glState, glRootView: this });
      }
      ...
      set glLayout (glLayout) {
        ...
        this._glLayout = glLayout;
        if (this.goldenLayout) {
          // Extract the current glSettings; we only want to change the layout
          this._glSettings = this.goldenLayout.toConfig();
          this._glSettings.content[0] = this._glLayout;

          // Make sure existing views are properly destroyed
